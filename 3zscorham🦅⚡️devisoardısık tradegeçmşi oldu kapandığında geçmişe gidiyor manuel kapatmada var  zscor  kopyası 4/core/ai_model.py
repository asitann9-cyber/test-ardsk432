...
class CryptoMLModel:
    """🔥 DÜZELTME: Dengeli AI model sistemi + Pine Script Z-Score ceza sistemi (±1.5 sınırı)"""
    ...
    def _calculate_balanced_score(self, metrics: Dict) -> float:
        """🔥 YENİ: Manuel skorlama + Yön Uyumu Bonusu (Toplam 115 puan)"""
        score = 0.0
        ...
        # 🔥 YENİ: 8. TÜM YÖN UYUMU BONUSU (+15 puan)
    ...
    def get_model_info(self) -> Dict:
        ...
        return {
            ...
            'model_type': 'Balanced Regression + Pine Script Z-Score Penalty (±1.5 threshold)'
        }
