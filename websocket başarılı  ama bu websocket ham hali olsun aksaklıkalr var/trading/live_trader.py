...
def stop_live_trading() -> None:
    ...
    with _cleanup_lock:
        ...
        # 🔧 DÜZELTME: Pozisyonları ZORLA kapat ve trade geçmişine kaydet
        ...
        if current_positions:
            ...
            for symbol in current_positions.keys():
                try:
                    ...
                    if success:
                        logger.info(f"✅ {symbol} kapatıldı ve trade geçmişine kaydedildi")
                    time.sleep(1)
                except Exception as e:
        ...
        logger.info("✅ Live Trading durduruldu - Tüm pozisyonlar kapatıldı ve kaydedildi")
