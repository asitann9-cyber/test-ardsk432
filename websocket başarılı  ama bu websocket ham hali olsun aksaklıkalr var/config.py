...
def reset_live_trading():
    """🔧 GÜNCELLENDI: Live trading verilerini sıfırla - başarısızlık takipçilerini de temizle"""
    global live_trading_active, live_positions, _last_position_sync, _position_validation_errors
    global failed_symbols_global, failed_symbols_timestamps  # 🔥 YENİ EKLENEN SATIR
    ...
    # 🔥 YENİ: Başarısızlık takipçilerini temizle (ASTERUSDT sonsuz loop önleme)
    failed_symbols_global.clear()
    failed_symbols_timestamps.clear()
