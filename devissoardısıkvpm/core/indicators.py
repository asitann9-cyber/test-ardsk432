"""
📈 Teknik Göstergeler - VPMV Sistemi (4 Bileşen)
🔥 SADECE: SuperTrend bazlı VPMV (Volume-Price-Momentum-Volatility)
...
# ============================================
# VPMV BİLEŞENLERİ HESAPLAMA (SADECE 4 BİLEŞEN)
# ============================================

def calculate_vpmv_components(df: pd.DataFrame, atr_period: int = 10, multiplier: float = 3.0) -> Dict:
    """
    🔥 VPMV (Volume-Price-Momentum-Volatility) bileşenlerini hesapla
    SADECE 4 BİLEŞEN - SuperTrend bazlı reset mekanizması ile
    ...
    Returns:
        Dict: VPMV bileşenleri ve skor (4 bileşen)
    """
    try:
        ...
        # VPMV SKORU (Ağırlıklı ortalama - SADECE 4 BİLEŞEN)
        vpmv_score = (
...
# ============================================
# DEPRECATED FONKSIYONLAR (ESKİ SİSTEM)
# ============================================
