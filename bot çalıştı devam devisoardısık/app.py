...
def update_performance_metrics(n_intervals):
    """🔥 GÜNCELLEME: Toplam kar/zarar eklendi, efektif sermaye ve açık pozisyon kaldırıldı"""
    try:
        ...
        return html.Div([
            ...
            html.Div([
                html.H4("🏆 Kazanma Oranı", style={'margin': '0', 'fontSize': '14px', 'color': '#3b82f6'}),
                html.H2(f"{metrics['win_rate']:.1f}%", style={'color': '#3b82f6', 'margin': '5px 0', 'fontSize': '18px'})
            ], style={
                'width': '19%', 'display': 'inline-block', 'textAlign': 'center', 
