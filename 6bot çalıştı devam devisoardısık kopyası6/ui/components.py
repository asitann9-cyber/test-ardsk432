...
def create_signals_table():
    """🔥 Sinyaller tablosunu oluştur - Live Bot sütunu eklendi + C-Signal momentum"""
    return html.Div([
        ...
        dash_table.DataTable(
            ...
            columns=[
                ...
                {"name": "C-Signal", "id": "c_signal_momentum", 'type': 'numeric', 'format': {"specifier": ".2f"}},  # 🔥 YENİ SÜTUN
            ...
            style_data_conditional=[
                ...
                # 🔥 YENİ: C-Signal momentum renklendirme
                {
