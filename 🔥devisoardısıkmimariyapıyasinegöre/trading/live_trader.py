...
class LiveTradingBot:
    ...
    def fill_empty_positions(self) -> None:
        ...
        try:
            ...
            # 🚨 SORUN GİDERİLDİ: MUTLAKA SIRALA - AI skoruna göre azalan sırada
            logger.info("🔄 AI skoruna göre sıralama yapılıyor...")
            df = df.sort_values(
                by=['ai_score', 'deviso_ratio', 'run_perc', 'gauss_run', 'vol_ratio'],
                ascending=[False, False, False, False, False]
            )
            logger.info("✅ Sıralama tamamlandı")
