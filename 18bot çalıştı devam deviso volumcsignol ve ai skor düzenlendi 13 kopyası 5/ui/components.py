...
🔗 YENİ: WebSocket real-time tablosu eklendi
"""
...
def create_header():
    ...
    return html.Div([
        html.H1("🤖 AI Crypto Analytics + Live Trading Bot + WebSocket", style={
            'textAlign': 'center',
            'margin': '0 0 0.5rem 0',
            'fontSize': '2rem',
            'fontWeight': '700'
...
def create_control_panel():
    """🔗 Kontrol paneli bölümünü oluştur - WebSocket butonu eklendi"""
    return html.Div([
        html.Div([
        ...
        html.Button("🔗 WebSocket Başlat", id='btn-websocket', n_clicks=0, className='control-button websocket-button'),
...
def create_status_section():
    """🔗 Durum gösterge bölümünü oluştur - WebSocket durumu eklendi"""
    return html.Div([
        html.Div([
...
def create_websocket_status_section():
    """🔗 YENİ: WebSocket durum göstergesi"""
    return html.Div([
        html.H4("🔗 WebSocket Real-time Durumu", style={'textAlign': 'center', 'margin': '0 0 1rem 0'}),
        html.Div(id='websocket-status', style={'textAlign': 'center'})
    ], style={
        'marginBottom': '2rem',
        'padding': '1rem',
        'backgroundColor': '#2a2a2a',
...
def create_websocket_table():
    """🔗 YENİ: WebSocket Real-time tablosu"""
    return html.Div([
        html.H3("⚡ WebSocket Real-time Top 10", style={
            'textAlign': 'center',
            'margin': '0 0 1rem 0',
            'fontSize': '1.3rem',
            'fontWeight': '600',
        ...
        html.Div(id='websocket-stats', style={'textAlign': 'center', 'marginBottom': '1rem'}),
        dash_table.DataTable(
            id='websocket-table',
            columns=[
                {"name": "Coin", "id": "symbol"},
                ...
                {"name": "Real-time Fiyat", "id": "realtime_price"},
                {"name": "24h Değişim", "id": "price_change"},
                {"name": "1m Momentum", "id": "momentum_1m"},
            ...
            style_data_conditional=[
                ...
                # Momentum renklendirme
                {
                    'if': {'column_id': 'momentum_1m', 'filter_query': '{momentum_1m} contains +'},
                    'backgroundColor': '#22c55e',
                    'color': '#000000',
                    'fontWeight': 'bold'
                },
                ...
                # Combined score renklendirme (yüksek skor)
                {
                    'if': {'column_id': 'combined_score', 'filter_query': '{combined_score} >= 80'},
                    'backgroundColor': '#22c55e',
                    'color': '#000000',
                    'fontWeight': 'bold'
                },
...
def create_signals_table():
    """📊 Sinyaller tablosunu oluştur - Live Bot sütunu eklendi + Log Volume metrikleri"""
    return html.Div([
        ...
        dash_table.DataTable(
            ...
            columns=[
                ...
                {"name": "Log Volume", "id": "log_volume", 'type': 'numeric', 'format': {"specifier": ".2f"}},
                {"name": "Log Vol Mom", "id": "log_volume_momentum", 'type': 'numeric', 'format': {"specifier": ".2f"}},
                {"name": "Deviso %", "id": "deviso_ratio", 'type': 'numeric', 'format': {"specifier": ".2f"}},
                {"name": "C-Signal", "id": "c_signal_momentum", 'type': 'numeric', 'format': {"specifier": ".2f"}},
                {"name": "AI Skor", "id": "ai_score"},
                {"name": "🤖", "id": "live_status"},
            ...
            style_data_conditional=[
                ...
                # C-Signal momentum renklendirme
                {
                    'if': {'column_id': 'c_signal_momentum', 'filter_query': '{c_signal_momentum} > 5'},
                    'backgroundColor': '#22c55e',
                    'color': '#000000',
                    'fontWeight': 'bold'
                },
...
def create_websocket_interval_component():
    """🔗 YENİ: WebSocket interval component'i"""
    return dcc.Interval(
        id='websocket-interval',
        interval=RT_TABLE_REFRESH_INTERVAL,  # Daha hızlı güncelleme
        n_intervals=0
    )
...
def create_layout():
    """🔗 Ana layout'u oluştur - WebSocket tablosu eklendi"""
    return html.Div([
        # Header
        create_header(),
        ...
        # WebSocket durumu
        create_websocket_status_section(),
        ...
        create_websocket_interval_component()
...
def get_app_styles():
    """🔗 CSS stillerini döndür - WebSocket buton stilleri eklendi"""
    return """
        body {
