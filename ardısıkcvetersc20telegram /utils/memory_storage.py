...
class MemoryStorage:
    ...
    def add_permanent_symbol(self, symbol_data: Dict[str, Any]) -> None:
        ...
        if not existing_symbol:
            ...
            permanent_entry = {
                ...
                'manual_type_value': None,      # Manuel değer (Long/Short)
    ...
    def set_manual_type_override(self, symbol: str, new_type: str) -> bool:
        ...
        Args:
            ...
            new_type (str): Yeni tür (Long/Short)
        ...
        if permanent_symbol:
            ...
            permanent_symbol['max_consecutive_type'] = new_type  # Ana türü de güncelle
    ...
    def get_manual_type_info(self, symbol: str) -> Dict[str, Any]:
        ...
        if permanent_symbol:
            return {
                ...
                'current_type': permanent_symbol.get('max_consecutive_type')
            }
        return {
            'is_manual': False,
            'manual_type': None,
