...
from config import LOCAL_TZ, TRADES_CSV, CAPITAL_CSV, open_positions, current_capital
...
def log_capital_to_csv():
    ...
    try:
        ...
        logger.debug(f"💰 Sermaye kaydedildi: ${current_capital:.2f}")
...
def calculate_performance_metrics():
    ...
    try:
        ...
        total_return = ((effective_capital - 1000.0) / 1000.0 * 100)  # INITIAL_CAPITAL = 1000
...
def export_to_excel(filename: str = None):
    ...
    try:
        if filename is None:
            ...
            filename = f"crypto_trading_report_{timestamp}.xlsx"
