...
class LiveTradingBot:
    ...
    def fill_empty_positions(self) -> None:
        ...
        try:
            ...
            # 🔥 TEMEL DEĞİŞİKLİK: UI'deki hazır veriyi doğrudan kullan
            ...
            # 🔥 ÖNEMLİ: UI'deki filtrelenmiş ve sıralanmış veriyi DOĞRUDAN kullan
            ...
            # 🔥 KRİTİK: SIRALAMAYA DOKUNMA - UI'deki sıralama korunacak
