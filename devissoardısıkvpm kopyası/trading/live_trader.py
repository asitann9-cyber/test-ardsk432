...
class LiveTradingBot:
    ...
    def _log_trade_to_csv(self, trade_data: Dict, status: str) -> None:
        """📝 Trade'i CSV'ye kaydet - VPMV uyumlu."""
        try:
            ...
            csv_data = {
                ...
                "commission": 0.0,
                # AI ve run type - zorunlu
                "ai_score": signal_data.get("ai_score", 50),
                "run_type": signal_data.get("run_type", "long"),
                # VPMV türevi alanlar - analyzer'dan geliyor
                "run_count": signal_data.get("run_count", 0),
                "run_perc": signal_data.get("run_perc", 0.0),
                "gauss_run": signal_data.get("gauss_run", 0.0),
                "vol_ratio": signal_data.get("log_volume", 0.0),  # log_volume olarak gelir
