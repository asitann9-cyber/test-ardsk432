"""
🔧 Kripto AI Sistemi - Konfigürasyon Dosyası - HİBRİT SİSTEM
🔥 YENİ: Hibrit yaklaşım - Veri mainnet'ten, Trading testnet'te
📊 TABLO VERİLERİ: Mainnet Binance'den gerçek piyasa verileri
🤖 LIVE TRADING: Testnet Binance'de güvenli test trading
"""
...
# =============================================================================
# 🔑 LIVE TRADING AYARLARI (DEĞİŞMEDİ)
# =============================================================================
...
# 🔥 HİBRİT SİSTEM: Veri için mainnet, Trading için environment'a göre

# 📊 VERİ ÇEKME ENDPOİNTLERİ (HER ZAMAN MAİNNET)
DATA_ENVIRONMENT = "mainnet"  # Veri için her zaman mainnet
DATA_BASE = "https://fapi.binance.com"  # Mainnet - gerçek piyasa verileri için
DATA_WS_BASE = "wss://fstream.binance.com"

# VERİ ÇEKİM URL'LERİ (MAİNNET)
DATA_EXCHANGE_INFO = f"{DATA_BASE}/fapi/v1/exchangeInfo"
DATA_KLINES = f"{DATA_BASE}/fapi/v1/klines"

# 🤖 TRADİNG ENDPOİNTLERİ (ENVIRONMENT'A GÖRE - DEĞİŞMEDİ)
if ENVIRONMENT == 'testnet':
    TRADING_BASE = "https://testnet.binancefuture.com"
    TRADING_WS_BASE = "wss://fstream.binancefuture.com"
else:
    TRADING_BASE = "https://fapi.binance.com"
    TRADING_WS_BASE = "wss://fstream.binance.com"

# 🔄 GERİYE UYUMLULUK İÇİN (eski kodların çalışması için)
BASE = TRADING_BASE  # Live trader için
WS_BASE = TRADING_WS_BASE
EXCHANGE_INFO = f"{TRADING_BASE}/fapi/v1/exchangeInfo"  # Trading için
KLINES = f"{TRADING_BASE}/fapi/v1/klines"  # Trading için (kullanılmayacak artık)
...
DASH_CONFIG = {
    ...
    'host': "127.0.0.1",
    'port': 8050,
    'title': "🤖 AI Crypto Analytics + Live Trading Bot - Hibrit Sistem"
}
...
def initialize():
    ...
    logger.info("🚀 Kripto AI sistemi - HİBRİT SİSTEM")
    logger.info(f"📊 VERİ KAYNAGI: {DATA_ENVIRONMENT} ({DATA_BASE})")
    logger.info(f"🤖 TRADİNG ENVIRONMENT: {ENVIRONMENT} ({TRADING_BASE})")
    logger.info(f"📊 Maksimum pozisyon: {MAX_OPEN_POSITIONS}")
    logger.info(f"⏰ Tarama aralığı: {SCAN_INTERVAL} saniye")
    logger.info("🎯 Hibrit Sistem: Tablo mainnet'ten, Trading testnet'te")
