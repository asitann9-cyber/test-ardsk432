...
class BinanceService:
    ...
    # Timeframe limitleri - her timeframe için minimum veri miktarı
    TIMEFRAME_LIMITS = {
    ...
    @classmethod
    def fetch_klines_data(cls, symbol: str, timeframe: str) -> Optional[pd.DataFrame]:
        """
        ...
        """
        try:
            limit = cls.TIMEFRAME_LIMITS.get(timeframe, 30)
            ...
            logger.debug(f"Veri çekildi: {symbol} {timeframe} - {len(df)} mum")
            return df
