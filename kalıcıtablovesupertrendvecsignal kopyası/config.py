...
🆕 YENİ: C-Signal ±20 Threshold - Long/Short Sinyal Tespiti
"""
...
class Config:
    ...
    # 🆕 C-SIGNAL ALERT CONFIGURATION
    C_SIGNAL_ALERT_THRESHOLD = 20.0  # ±20 veya üzeri için alert
    C_SIGNAL_LONG_THRESHOLD = 20.0   # +20 veya üzeri = LONG (L) sinyali
    C_SIGNAL_SHORT_THRESHOLD = -20.0 # -20 veya altı = SHORT (S) sinyali
    ...
    def validate_config(cls):
        ...
        # 🆕 C-Signal threshold kontrolü
        if cls.C_SIGNAL_ALERT_THRESHOLD <= 0:
            errors.append("ERROR: C_SIGNAL_ALERT_THRESHOLD pozitif olmalı")
    ...
    def get_summary(cls):
        ...
        return {
            ...
            'c_signal_threshold': cls.C_SIGNAL_ALERT_THRESHOLD,  # 🆕
