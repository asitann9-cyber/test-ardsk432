...
class MemoryStorage:
    ...
    def __init__(self):
        ...
        self.system_stats: Dict[str, Any] = {
            ...
            'c_signal_alerts_sent': 0  # 🆕 C-Signal alert sayacı
        }
    ...
    def add_permanent_symbol(self, symbol_data: Dict[str, Any]) -> None:
        ...
        if not existing_symbol:
            ...
            permanent_entry = {
                ...
                'last_c_signal_type': None,  # 'L', 'S', veya None
                'last_c_signal_alert_time': None,
                'c_signal_history': []  # Son 10 C-Signal değerini tut
            }
    ...
    def update_c_signal(self, symbol: str, c_signal_value: Optional[float]) -> Dict[str, Any]:
        ...
        # C-Signal tarihçesine ekle (son 10 değeri tut)
    ...
    def _check_c_signal_threshold(self, symbol: str, current_value: float, 
        ...
        """
        C-Signal ±20 threshold kontrolü
        ...
        """
        # Config'den threshold değerlerini al (bu dosyada import yapmadan sabit değer kullanıyoruz)
        LONG_THRESHOLD = 20.0
        ...
        # LONG sinyali kontrolü (>=+20)
        if current_value >= LONG_THRESHOLD:
            # Önceki değer threshold altındaysa veya yoksa sinyal ver
            if previous_value is None or previous_value < LONG_THRESHOLD:
                signal_triggered = True
                signal_type = 'L'
                reason = f"C-Signal crossed +20 threshold: {current_value:.2f}"
        
        # SHORT sinyali kontrolü (<=-20)
        elif current_value <= SHORT_THRESHOLD:
            # Önceki değer threshold üstündeyse veya yoksa sinyal ver
    ...
    def clear_c_signal_alert(self, symbol: str) -> bool:
        """
        C-Signal alert'ini temizle (manuel silme)
