            ...
            if results:
                ...
                for result in results:
                    ...
                    if ratio >= ratio_threshold:
                        ...
                        logger.info(f"✅ {result['symbol']} kalıcı listeye eklendi (Ratio: {ratio}% >= {ratio_threshold}%)")
                ...
                return jsonify({
                    ...
                    "message": f"{len(formatted_results)} sembol analiz edildi - {high_priority_count} sembol kalıcı listeye eklendi - {len(c_signal_alerts)} C-Signal alert (±{c_signal_threshold})"
                })
            else:
