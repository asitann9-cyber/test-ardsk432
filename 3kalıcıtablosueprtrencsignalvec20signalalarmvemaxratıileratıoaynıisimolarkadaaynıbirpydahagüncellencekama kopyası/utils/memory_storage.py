...
class MemoryStorage:
    ...
    def _check_c_signal_threshold(self, symbol: str, current_value: float, 
        ...
        LONG_THRESHOLD = Config.get_c_signal_long_threshold()    # Örn: +20, +10, +5
        SHORT_THRESHOLD = Config.get_c_signal_short_threshold()  # Örn: -20, -10, -5
        ...
        return {
            ...
            'reason': reason,
            'threshold_used': abs(LONG_THRESHOLD)  # 🆕 Hangi threshold kullanıldığını da döndür
        }
