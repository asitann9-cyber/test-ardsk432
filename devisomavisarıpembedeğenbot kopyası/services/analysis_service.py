"""
Analiz servisleri
Supertrend analizi, C-Signal hesaplama ve Devis'So Trend çizgi takibi
"""
...
class AnalysisService:
    """Supertrend ve Devis'So Trend analizi için service sınıfı"""
    ...
    def calculate_deviso_trend(df: pd.DataFrame) -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            return {
                'ma_all_signals': ma_all_signals.fillna(method='ffill'),      # Mavi çizgi
                'ma_all_signals2': ma_all_signals2.fillna(method='ffill'),    # Pembe çizgi
                'ma_average': ma_mid.fillna(method='ffill'),                  # Sarı çizgi
    ...
    def detect_deviso_line_contact(symbol_data: Dict[str, Any], df: pd.DataFrame) -> Dict[str, Any]:
        """
        Devis'So çizgi temas tespiti - LONG trend için
        ...
        """
        try:
            # Sadece LONG (Bullish) trend için çalıştır
            ...
            # LONG trend için çizgi sıralaması kontrol: Mavi > Sarı > Pembe
            ...
            # Seviye 2: Sarı çizgiye temas (Mavi geçildi)
            ...
            # Seviye 3: Pembe çizgiye temas (Sarı da geçildi)
    ...
    def analyze_single_symbol(symbol: str, timeframe: str = '4h') -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            return {
                ...
                'deviso_lines': deviso_line_values,  # YENİ: Devis'So çizgi değerleri
